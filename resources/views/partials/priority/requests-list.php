<div x-data="requestsList">
  ...
  -->
  <ul class="d-flex flex-column gap-2 px-4 px-md-2" id="pinned-requests-list" @pinned-moved.document="pinnedMoved( event )">
  ...
  -->
  <ul class="d-flex flex-column gap-2 px-4 px-md-2" id="requests-list">
