<!---------------------------------- Observaciones ---------------------------------->
<!-- <div class="overflow-auto mt-2" style="overflow-y: scroll;"> -->
  <div 
  ...
  x-init="$nextTick(() => getObs());" class="overflow-auto position-relative">
    ...
    x-show="showObsList" x-collapse x-ref="mainObsList" style="min-height: 150px;">
      ...
      <div class="list-group px-2 position-relative">
        <!-- Se listan las observaciones -->
        <template x-for="ob in obs" :key="ob.id">
          <div class="p-1 py-2 text-small list-group-item list-group-item-action flex align-items-center" :class="bgColor(ob)">
